...
-- Equipment
ActorInventory:defineInventory("WEAPON", "Weapon", true, "Weapons are used to smite the evil ones")
ActorInventory:defineInventory("SHIELD", "Shield", true, "Shield provide defensive bonuses against harmful attacks")

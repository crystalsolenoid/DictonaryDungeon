...
newEntity{ define_as = "BASE_A",
    type = "creature",
	display = "A", color=colors.RED,
    desc = [[ a small insect, often with a sting, that usually lives in a complex social colony with one or more breeding queens. It is wingless except for fertile adults, which often form large mating swarms, and is proverbial for industriousness. ]],
...
newEntity{ define_as = "BASE_B",
    type = "creature",
	display = "B", color=colors.BLUE,
    desc = [[a mainly nocturnal mammal capable of sustained flight, with membranous wings that extend between the fingers and connecting the forelimbs to the body and the hindlimbs to the tail.]],
    ai = "dumb_talented_simple", ai_state = { talent_in=3, },
	name = "bat",
	level_range = {2,2}, exp_worth = 1,
	rarity = 4,
	max_life = resolvers.rngavg(2,4),
	base_dam = resolvers.rngavg(1,2),
	max_dam = resolvers.rngavg(2,3),

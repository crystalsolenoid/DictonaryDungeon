...
newEntity{
	define_as = "DOWN",
	name = "next level",
	display = '>', color_r=255, color_g=255, color_b=0, back_color=colors.BLACK,
	notice = true,
	always_remember = true,
	change_level = 1,
}
...
newEntity{
	define_as = "FLOOR",
	name = "floor",
	display = '.', color_r=225, color_g=225, color_b=225, back_color=colors.BLACK,
	always_remember = true,
}
...
newEntity{
	define_as = "WALL",
	name = "wall",
	display = '#', color_r=105, color_g=105, color_b=105, back_color=colors.BLACK,
	always_remember = true,
